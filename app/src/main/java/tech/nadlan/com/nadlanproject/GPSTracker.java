...
public class GPSTracker extends Service implements LocationListener {
    ...
    public Location getLocation() {
        ...
        try {
            ...
            Log.d("testlocation", String.valueOf(isNetworkEnabled));
    ...
    public void onLocationChanged(Location location) {
        Log.d("testlocation","onLocationChanged");
    ...
    public void networkLocation ()
    {
        if (isNetworkEnabled) {
            ...
            if (locationManager != null) {
                ...
                Log.d("testlocation", "1");

                location = locationManager.getLastKnownLocation(LocationManager.NETWORK_PROVIDER);
                if (location != null) {
                    Log.d("testlocation", "2");

                    latitude = location.getLatitude();
                    longitude = location.getLongitude();
                    Log.d("testlocation", String.valueOf(location));
    ...
    @SuppressLint("MissingPermission")
    public void passiveLocation ()
    {
        Log.d("testlocation", "passive");


        if (location == null) {
            Log.d("testlocation", "1");

            locationManager.requestLocationUpdates(LocationManager.PASSIVE_PROVIDER, MIN_TIME_BW_UPDATES, MIN_DISTANCE_CHANGE_FOR_UPDATES, this,Looper.getMainLooper());
            if (locationManager != null) {
